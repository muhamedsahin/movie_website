    ...
    <article>
      ...
      <section class="hero">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle">Overclock movie</p>

            <h1 class="h1 hero-title">
              Limitsiz <strong>Filim</strong>, Amine, & Fazlası.
            </h1>
        ...
        <div class="container">
          ...
          <div class="flex-wrapper">
            ...
            <div class="title-wrapper">
              ...
              <h2 class="h2 section-title">Yaklaşan Filim ve Diziler</h2>
            </div>
      ...
      <section class="top-rated">
        <div class="container">
          ...
          <h2 class="h2 section-title">En iyi Dereceli Filimler</h2>
      ...
      <section class="tv-series">
        <div class="container">
          ...
          <h2 class="h2 section-title">Dünyanın En iyi Animeleri</h2>
      ...
      <section class="cta">
        <div class="container">
          ...
          <div class="title-wrapper">
            <h2 class="cta-title">Yeni Dizi Filim ve Animelerden Haberdar ol</h2>

            <p class="cta-text">
              Lütfen Mail ala bilmek için Email adresinizi giriniz
            </p>
          </div>
          ...
          <form action="" class="cta-form">
            ...
            <button type="submit" class="cta-form-btn">Kayıdı Tamamla</button>
          </form>
  ...
  <footer class="footer">
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2025 <a href="#">OverColock Studio</a>. Tüm hakkları saklıdır
        </p>
