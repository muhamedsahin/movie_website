  ...
  -->
      <section class="parts">
        <div class="container">
          ...
          <h2 class="h2">Dizinin bölümleri</h2>

          <ul class="movies-list">

            <li>
                <div class="Bolum details-actions">
                  <div class="title-wrapper">
                    <p class="title">1. Bölüm</p>

                    <p class="text">Squid Game</p>
                  </div>
